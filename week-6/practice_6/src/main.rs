fn main() {
    ...
    let n4 = n1 + &n2 + &n3; //n1 & n2 reference is passed

    println!("\nThe {} is informed by the aspiration to to train electrical/electronic
        engineering professionals in the areas of design, building and maintenance of 
        electronical control systems.", n4);
    ...
    println!("{} is aimed at developing competent, creative, innovative, entrepreneurial 
        and ethically-minded persons, capable of creating value in the diverse fields of 
        Computer Science.",w3);
}
